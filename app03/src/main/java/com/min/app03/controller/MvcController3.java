...
public class MvcController3 {
   ...
   * Query String 은 Parameter 형태로 HTTPServletRequest인터페이스 객체에 저장되어 있습니다.
   * getParameter() 또는 getParameterValues() 매소드를 이용해 Parameter 를 확인할 수 있습니다.
   * getParameter() 매소드는 String 을 반환하고, getParameterValues() 매소드는 String[] 을 반환합니다.
   */
  ...
  public String req4(HttpServletRequest request) {
    ...
    // Parameter page 를 Optional 에 담습니다. Parameter page 는 ofNullable() 메소드로 담았기 때문에 없어도 오류가 발생하지 않숩니다.
    Optional<String> opt = Optional.ofNullable(request.getParameter("page"));
    
    // Optional 에 담은 Parameter page 를 꺼냅니다. 이때 Parameter page 가 없으면 "1" 을 꺼냅니다.
   ...
   * 각 Parameter 마다 RequestParam Annotation 을추가하여 Parameter 를 직접 변수로 받을 수 잇습니다.
