...
public class MvcController1 {
  ...
  /*
   * 반환타입
   *   1) String       : 사용자에게 보여줄(응답할) JSP(html파일) 의 경로와 이름을 작성합니다.
   ...
   *   1) method=RequestMethod.POST : POST 방식을 의미합니다. 
   */
  ...
  public String welcome() {
     ...
     * 3. ViewResolver 는 "webdir1/index" enldp ".jsp" 문자열을 추가합니다. (suffix)
     * 4. ViewResolver 는 완성도니 최종 View 로 이동합니다.
  ...
  public void letsgo() {
    /*
     * 반환타입이 void 이므로 요청주소 "/webdir1/list" 를 사용자에게 보여 출 JPS 경로와 이름으로 해석합니다.
