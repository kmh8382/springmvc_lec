...
public class BoardController {
  ...
  public String list(HttpServletRequest request, Model model) {
    ...
    // 목록 서비스(getBoardList)로부터 결과흫 받아옵니다.
  ...
  public String Modify(BoardDto boardDto, RedirectAttributes redirectAttributes) {
    ...
    // 수정 서비스로부터 수정 결과를 받아온 뒤, 해당 리다이렉트 할 수 있도록 redirectAttributes에 저장합니다.    
  ...
  public String remove(int boardId, RedirectAttributes redirectAttributes) {   // @RequestParam 생략 가능
    
    // 삭제 서비스로부터 삭제 결과를 받아온 뒤, 해당 리다이렉트 할 수 있도록 redirectAttributes에 저장합니다.    
  ...
  public String register(BoardDto boardDto, RedirectAttributes redirectAttributes) {
    ...
    // 삽입 서비스로부터 삽입 결과를 받아온 뒤, 해당 리다이렉트 할 수 있도록 redirectAttributes에 저장합니다.  
  ...
  public String search(HttpServletRequest request, Model model) {  
    ...
    // 검색 결과 목록과 검색 결과 개수를 jsp로 전달할 목록과 전체 목록 개수를 model에 저장합니다.
    model.addAttribute("boardList", map.get("boardList"));
    model.addAttribute("boardCount", map.get("boardCount"));
